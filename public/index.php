...
<img src="https://png.pngtree.com/png-vector/20191104/ourmid/pngtree-businessman-avatar-cartoon-style-png-image_1953664.jpg" alt="">
     ...
     <div>
            ...
            <li>
                ...
                <a href="#expirence">Profesional Expirence</a> 
            </li>
                <li>

                    <a href="#heading">Education</a> 
                </li>
                <li>

                    <a href="#course">Courcec</a> 
                </li>
                </p>
            <h3 id="expirence">Professional Experience</h3>
            <h4 >Wingify Software Pvt Ltd</h4>
            ...
            <h3 id="course">Independent Courses</h3>
            <p>
            <ul>
                <li>
